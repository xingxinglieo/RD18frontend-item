  ...
  <div>
    <el-container>
      <el-header class="header">
        <el-button @click="alterMailbox = true, alterPassword = false">更换邮箱</el-button>
        <el-button @click="alterMailbox = false, alterPassword = true">修改密码</el-button>
      </el-header>
      <el-main class="main">
        <!-- 更换邮箱 -->
        <el-main class="step">
        ...
        <div v-show="alterPassword">
          ...
          <el-main class="step">
            ...
            <el-input show-password
              ...
              minlength="8"
              maxlength="16"
             @focus="checkFirstInput()" @blur="checkSecondInput()"></el-input>
            <span v-show="check6">
            <svg class="icon" aria-hidden="true">
              <use xlink:href="#iconjinggao" />
            </svg> {{certainPasswordMsg}}
          </span>
          </el-main>
        </div>
        <el-main class="step">
        ...
        <el-main class="step"><el-button class="submit-userRequest" @click="submitUserRequest()">确认修改</el-button></el-main>
      </el-main>
    </el-container>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    checkSecondInput() {
      ...
      } else if (this.certainPassword != this.newPassword && this.newPassword != ""){
         this.check6 = true;
    ...
    submitUserRequest() {
      if(this.alterMailbox == true) {  // 修改邮箱
        if(this.currentMailbox == "" || this.password == "" || this.newMailbox == "" || this.certainMailbox == "" || this.code == "" || this.check1 == true || this.check2 == true || this.check3 == true || this.check4 == true) {
        ...
        if(this.currentMailbox == "" || this.password == "" || this.newPassword == "" || this.certainPassword == "" || this.code == "" || this.check1 == true || this.check2 == true || this.check5 == true || this.check6 == true) {
          alert("请正确并且完整地填写相关信息！");
          return;
        } else { // 发起请求
