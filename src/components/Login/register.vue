    ...
    <form>
      ...
      <el-popover placement="right" width="120" trigger="focus" :disabled="isPassword">
        ...
        <span v-if="!isPassword">
          <i class="el-icon-warning-outline"></i> 长度为8-18个字符,必须包含字母,数字,符号中的两种
        </span>
      </el-popover>
      <el-input placeholder="请确认密码" v-model="confirm" show-password></el-input>
      <div class="blank">
        <transition name="el-fade-in">
          <div v-if="confirm!==''">
            <div style="height: 18px;position:relative;">
              <transition name="el-fade-in">
                ...
                <span
                  ...
                  style="color: darkred;font-size: 14px;position:absolute;"
                >
